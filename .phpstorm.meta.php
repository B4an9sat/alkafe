...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\xampp\htdocs\alkafe\public\storage' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\xampp\\htdocs\\alkafe\\public\\storage',
...
'signed','throttle','verified','admin','kasir',
'manager',);
        registerArgumentsSet('routes', 
'sanctum.csrf-cookie','dashboard','profile.edit',
'profile.update','profile.destroy','kasir.pos','kasir.processTransaction','kasir.transaksi',
'kasir.transaksi.detail','kasir.laporan','products.index','products.create','products.store',
'products.show','products.edit','products.update','products.destroy','customers.index',
'customers.create','customers.store','customers.show','customers.edit','customers.update',
'customers.destroy','categories.index','categories.create','categories.store','categories.show',
'categories.edit','categories.update','categories.destroy','users.index','users.create',
'users.store','users.show','users.edit','users.update','users.destroy',
'admin.dashboard','manager.dashboard','register','login','password.request','password.email','password.reset','password.store',
'password.confirm','password.update','logout','storage.local',);
        registerArgumentsSet('views', 
'admin.dashboard','auth.confirm-password','auth.forgot-password','auth.login','auth.reset-password',
...
'components.primary-button','components.responsive-nav-link','components.secondary-button','components.text-input','customers.index',
'dashboard','kasir.pos','kasir.reports.sales','kasir.transactions.detail','kasir.transactions.history',
'layouts.app','layouts.guest','layouts.navigation','manager.dashboard','products.create',
'products.edit','products.index','products.show','profile.edit','profile.partials.delete-user-form',
...
'CACHE_DRIVER','MEMCACHED_HOST','REDIS_CLIENT','REDIS_HOST','REDIS_PASSWORD',
